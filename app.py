...
class Show(db.Model):
    ...
    # Set up relationship with Artist & Venue
...
# db.create_all() replaced by migration
...
def venues():
  ...
  # Mock data (use as backup for front end view):
  # data=[{
  #   "city": "San Francisco",
  #   "state": "CA",
  #   "venues": [{
...
def show_artist(artist_id):
  ...
  # Mock data (keep as backup for front-end view)
  # data1={
  #   "id": 4,
  #   "name": "Guns N Petals",
  #   "genres": ["Rock n Roll"],
